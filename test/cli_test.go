...
func TestCLI(t *testing.T) {
	...
	skipCases := map[string]string{
		...
		"TestCLI/v=0.12/tf=example_org_policy_policy/offline=false/cmd=validate/constraint=always_violate":  	   "skip because test runner in unable to fetch project id",
		"TestCLI/v=0.12/tf=example_org_policy_policy/offline=true/cmd=validate/constraint=always_violate":  	   "skip because test runner in unable to fetch project id",
